...
const routes: Routes = [

  {
    path: '',
    children: [
      {path: 'asesorias', component: AsesoriasComponent, data:{title: 'Asesorias', icon:'fa-solid fa-users-gear', showInMenu: true, breadcrumbs:['Asesorias']}},
      {path: 'list-ruta-asesor', component: ListRutaComponent, data: {title: 'Rutas', showInMenu:true, icon: 'fa-solid fa-location-arrow', breadcrumbs:['Rutas']}},
      ...
      {path: 'perfil-asesores', component: PerfilAsesorComponent, data:{title: 'Perfil', icon:'fa-solid fa-circle-user', showInMenu: true, breadcrumbs:['Perfil']}},
    ]
  }
];
